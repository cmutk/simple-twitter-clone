<template>
 <list-card
        ...
        :bg-color="'white-bg'"
        header-text="Relevant people"
      >
        <template v-slot:content>
        <li class="flex py-10px px-15px border-b border-gray-light cursor-pointer" 
        >
          <div class="flex flex-row w-full">
            ...
            <div class="flex-shrink flex flex-col flex-1">
             ...
             <div class="flex items-center self-center h-30px">
               ...
               <span class="flex">{{relevantUser.info}}</span>
            </div>
          </div>
        </li>
        </template>
...
export default {
  ...
  computed: {
    relevantUser() {
      return this.$store.getters.getSelectedTweet.user;
    },
  },
}
</script>
