<template>
  <generic-main>
    <primary-column border-style="column" class="bg-gray-light">
      ...
      <li
        class="flex py-10px px-15px bg-white border-b border-gray-light cursor-pointer"
      >
        <div class="flex-shrink flex flex-col flex-1">
          <div class="flex flex-row mb-5px">
            ...
            <div
              class="inline-flex flex-grow flex-row justify-between items-baseline"
            >
              <span>
                <router-link
                  :to="{
                ...
                >
                  ...
                  <span class="font-normal text-gray-dark"
                    >@{{ selectedTweet.user.name }}</span
                  >
                </router-link>
              </span>
          ...
          >
            <span class="mr-20px">
              <span class="font-bold mr-5px">{{
                selectedTweet.replies.length
              }}</span>
